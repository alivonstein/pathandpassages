  ...
  return (
    <section className="relative w-full">
      ...
      >
        ...
        {/* Text on bottom right, aligned with mobile image column (px-1 = 4px padding) */}
        <span className="absolute bottom-2 right-1 text-white text-xs font-light tracking-wide md:hidden">
          project proposal
        </span>
      </button>
    </section>
