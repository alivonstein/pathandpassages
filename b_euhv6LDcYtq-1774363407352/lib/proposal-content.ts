// Project proposal content - extracted to avoid template literal parsing issues

export const projectProposalContent = `The Problem: Context and Pathology
...
Participants pay 100 Euro/day for room and board plus additional fees for studio use and materials.

Year 1:
• Average retreat length: 20 days
• Studio/Equipment fees: 400 Euro/participant per retreat
• 10-15 participants per retreat
• Retreats per year: 6
• Average participants: 12
• Revenue per participant (20 days): 2.400 Euro (board) + 400 Euro (studio) = 2.800 Euro
• Annual Revenue: 12 participants x 6 retreats x 2.800 Euro = 201.600 Euro

Year 5:
• Average retreat length: 20 days
• Studio/Equipment fees: 400 Euro/participant per retreat
• Retreats per year: 8 | Average participants: 30
• Revenue per participant (20 days): 2.400 Euro (board) + 400 Euro (studio/equipment) = 2.800 Euro
• Annual Revenue: 30 participants x 8 retreats x 2.800 Euro = 576.000 Euro
...
export const projectProposalTables = [
  ...
  },
  {
    ...
    headers: ["Item", "Amount"],
    rows: [
      ["Purchase of Property and Land", "500.000 Euro"],
      ["Sound Studio", "50.000 Euro"],
      ["Artist Studios", "75.000 Euro"],
      ["Meditation / Dance / Community Space", "60.000 Euro"],
      ["Session Rooms", "30.000 Euro"],
      ["Accommodation (10 double rooms with ensuite bathrooms)", "250.000 Euro"],
      ["Kitchen Equipment", "30.000 Euro"],
      ["Dining Area Furniture", "15.000 Euro"],
      ["Small Van (6-9 Seats)", "40.000 Euro"],
      ["Initial Stock (miscellaneous supplies)", "10.000 Euro"],
      ["Permits and Legal Expenses", "20.000 Euro"],
      ["Marketing and Networking", "25.000 Euro"],
      ["Start-Up & Infrastructure Expenditures", "1.105.000 Euro"]
    ]
  },
  {
    ...
    rows: [
      ["Salaries (staff, admin, facilitators)", "150.000 Euro", "250.000 Euro"],
      ["Utilities and Maintenance", "30.000 Euro", "50.000 Euro"],
      ["Food and Supplies", "100.000 Euro", "200.000 Euro"],
      ["Transportation", "5.000 Euro", "12.000 Euro"],
      ["Marketing / Networking", "20.000 Euro", "30.000 Euro"],
      ["Miscellaneous / Maintenance", "20.000 Euro", "58.000 Euro"],
      ["Total", "325.000 Euro", "600.000 Euro"]
    ]
  },
  {
    marker: "[[TABLE_GROWTH]]",
    ...
    rows: [
      ...
      ["3", "20", "7", "392.000 Euro", "410.000 Euro", "-18.000 Euro"],
      ["4", "25", "8", "560.000 Euro", "450.000 Euro", "110.000 Euro"],
      ["5", "30", "8", "672.000 Euro", "600.000 Euro", "172.000 Euro"]
    ]
  }
]
